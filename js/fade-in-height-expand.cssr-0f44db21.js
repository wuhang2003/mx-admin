import{h as $,c as h}from"./fade-in.cssr-c6d077ce.js";const{cubicBezierEaseInOut:e,cubicBezierEaseOut:f,cubicBezierEaseIn:g}=h;function b({overflow:s="hidden",duration:t=".3s",originalTransition:i="",leavingDelay:n="0s",foldPadding:p=!1,enterToProps:c=void 0,leaveToProps:d=void 0,reverse:m=!1}={}){const a=m?"leave":"enter",o=m?"enter":"leave";return[$(`&.fade-in-height-expand-transition-${o}-from,
