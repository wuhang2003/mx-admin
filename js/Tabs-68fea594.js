...
`,[c("segment-type",[r("tabs-rail",[x("&.transition-disabled","color: red;",[r("tabs-tab",`
 ...
 display: flex;
 align-items: center;
 `),L("prefix","padding-right: 16px;"),L("suffix","padding-left: 16px;")]),r("tabs-nav-scroll-wrapper",`
 flex: 1;
 position: relative;
 overflow: hidden;
 ...
 `),c("disabled",{color:"var(--n-tab-text-color-disabled)"})])]),r("tabs-nav",[c("line-type",[L("prefix, suffix",`
 transition: border-color .3s var(--n-bezier);
