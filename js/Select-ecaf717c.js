...
`,[j("icon",`
 ...
 `)]),mo=Object.assign(Object.assign({},he.props),{description:String,showDescription:{type:Boolean,default:!0},showIcon:{type:Boolean,default:!0},size:{type:String,default:"medium"},renderIcon:Function}),yo=ae({name:"Empty",props:mo,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:n}=zt(e),o=he("Empty","-empty",po,cn,e,t),{localeRef:i}=Pt("Empty"),s=ct(fn,null),a=A(()=>{var h,v,O;return(h=e.description)!==null&&h!==void 0?h:(O=(v=s?.mergedComponentPropsRef.value)===null||v===void 0?void 0:v.Empty)===null||O===void 0?void 0:O.description}),r=A(()=>{var h,v;return((v=(h=s?.mergedComponentPropsRef.value)===null||h===void 0?void 0:h.Empty)===null||v===void 0?void 0:v.renderIcon)||(()=>f(Wn,null))}),m=A(()=>{const{size:h}=e,{common:{cubicBezierEaseInOut:v},self:{[ue("iconSize",h)]:O,[ue("fontSize",h)]:M,textColor:b,iconColor:F,extraTextColor:$}}=o.value;return{"--n-icon-size":O,"--n-font-size":M,"--n-bezier":v,"--n-text-color":b,"--n-icon-color":F,"--n-extra-text-color":$}}),u=n?He("empty",A(()=>{let h="";const{size:v}=e;return h+=v[0],h}),m,e):void 0;return{mergedClsPrefix:t,mergedRenderIcon:r,localizedDescription:A(()=>a.value||i.value.description),cssVars:n?void 0:m,themeClass:u?.themeClass,onRender:u?.onRender}},render(){const{$slots:e,mergedClsPrefix:t,onRender:n}=this;return n?.(),f("div",{class:[`${t}-empty`,this.themeClass],style:this.cssVars},this.showIcon?f("div",{class:`${t}-empty__icon`},e.icon?e.icon():f(Mt,{clsPrefix:t},{default:this.mergedRenderIcon})):null,this.showDescription?f("div",{class:`${t}-empty__description`},e.default?e.default():this.localizedDescription):null,e.extra?f("div",{class:`${t}-empty__extra`},e.extra()):null)}});function wo(e,t){return f(It,{name:"fade-in-scale-up-transition"},{default:()=>e?f(Mt,{clsPrefix:t,class:`${t}-base-select-option__check`},{default:()=>f(En)}):null})}const Rt=ae({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:t,pendingTmNodeRef:n,multipleRef:o,valueSetRef:i,renderLabelRef:s,renderOptionRef:a,labelFieldRef:r,valueFieldRef:m,showCheckmarkRef:u,nodePropsRef:h,handleOptionClick:v,handleOptionMouseEnter:O}=ct(ft),M=$e(()=>{const{value:R}=n;return R?e.tmNode.key===R.key:!1});function b(R){const{tmNode:T}=e;T.disabled||v(R,T)}function F(R){const{tmNode:T}=e;T.disabled||O(R,T)}function $(R){const{tmNode:T}=e,{value:D}=M;T.disabled||D||O(R,T)}return{multiple:o,isGrouped:$e(()=>{const{tmNode:R}=e,{parent:T}=R;return T&&T.rawNode.type==="group"}),showCheckmark:u,nodeProps:h,isPending:M,isSelected:$e(()=>{const{value:R}=t,{value:T}=o;if(R===null)return!1;const D=e.tmNode.rawNode[m.value];if(T){const{value:w}=i;return w.has(D)}else return R===D}),labelField:r,renderLabel:s,renderOption:a,handleMouseMove:$,handleMouseEnter:F,handleClick:b}},render(){const{clsPrefix:e,tmNode:{rawNode:t},isSelected:n,isPending:o,isGrouped:i,showCheckmark:s,nodeProps:a,renderOption:r,renderLabel:m,handleClick:u,handleMouseEnter:h,handleMouseMove:v}=this,O=wo(n,e),M=m?[m(t,n),s&&O]:[Ce(t[this.labelField],t,n),s&&O],b=a?.(t),F=f("div",Object.assign({},b,{class:[`${e}-base-select-option`,t.class,b?.class,{[`${e}-base-select-option--disabled`]:t.disabled,[`${e}-base-select-option--selected`]:n,[`${e}-base-select-option--grouped`]:i,[`${e}-base-select-option--pending`]:o,[`${e}-base-select-option--show-checkmark`]:s}],style:[b?.style||"",t.style||""],onClick:et([u,b?.onClick]),onMouseenter:et([h,b?.onMouseenter]),onMousemove:et([v,b?.onMousemove])}),f("div",{class:`${e}-base-select-option__content`},M));return t.render?t.render({node:F,option:t,selected:n}):r?r({node:F,option:t,selected:n}):F}}),Tt=ae({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:t,labelFieldRef:n,nodePropsRef:o}=ct(ft);return{labelField:n,nodeProps:o,renderLabel:e,renderOption:t}},render(){const{clsPrefix:e,renderLabel:t,renderOption:n,nodeProps:o,tmNode:{rawNode:i}}=this,s=o?.(i),a=t?t(i,!1):Ce(i[this.labelField],i,!1),r=f("div",Object.assign({},s,{class:[`${e}-base-select-group-header`,s?.class]}),a);return i.render?i.render({node:r,option:i}):n?n({node:r,option:i,selected:!1}):r}}),xo=L("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
